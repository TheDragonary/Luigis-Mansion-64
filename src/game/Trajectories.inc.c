...
const Trajectory KoopaBoB_path[] = {
	TRAJECTORY_POS(0, /*pos*/ -4004, 0, 5221),
	TRAJECTORY_POS(1, /*pos*/ -2460, 0, 3165),
	TRAJECTORY_POS(2, /*pos*/ -1912, 0, 1248),
	TRAJECTORY_POS(3, /*pos*/ -158, 303, -44),
	TRAJECTORY_POS(4, /*pos*/ 2322, 1449, -1398),
	TRAJECTORY_POS(5, /*pos*/ 2725, 1605, -2144),
	TRAJECTORY_POS(6, /*pos*/ 2687, 1605, -2686),
	TRAJECTORY_POS(7, /*pos*/ 2723, 4074, -2693),
	TRAJECTORY_POS(8, /*pos*/ 3078, 4056, -2884),
	TRAJECTORY_POS(9, /*pos*/ 4618, 4187, -3698),
	TRAJECTORY_POS(10, /*pos*/ 4620, 4226, -4299),
	TRAJECTORY_POS(11, /*pos*/ 3313, 4290, -4908),
	TRAJECTORY_END(),
};

//KoopaTHI Has a level embedded value, Default fallback used.
...
//rr_seg7_trajectory_0702EC3C_RM2C Has a level embedded value, Default fallback used.
...
//rr_seg7_trajectory_0702ECC0_RM2C Has a level embedded value, Default fallback used.
...
//ccm_seg7_trajectory_0701669C_RM2C Has a level embedded value, Default fallback used.
...
//bitfs_seg7_trajectory_070159AC_RM2C Has a level embedded value, Default fallback used.
